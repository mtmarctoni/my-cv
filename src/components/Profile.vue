...
const { firstName, lastName, title, email, phone, location, summary } = personalData.profile
        ...
        <div class="flex flex-col md:flex-row items-center md:items-center mt-6">
            ...
            <section class="w-full md:w-1/2 md:order-1 md:pr-8">
                ...
                <div class="space-y-2">
                    ...
                    <ContactItem :icon="ghIcon" text="GitHub" href="https://github.com/mtmarctoni" />
                    <ContactItem :icon="LinkedInIcon" text="LinkedIn" href="https://linkedin.com/in/marconimas" />
                </div>
            </section>
        </div>
