...
export const LocationIcon = {
    template: `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ghIcon = {
    template: `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
...
export const SolidityIcon = {
    template: `<svg viewBox="0 0 100 160" focusable="false" class="chakra-icon css-10om80z">
...
export const transcriptIcon = {
    template: `<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
