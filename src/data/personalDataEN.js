export const personalDataEN = {
    ...
    profile: {
      ...
      nick: 'MTM',
      position: 'Nanoscientist, Physicist and Developer',
    ...
    education: {
      ...
      educationList: [
        ...
        },
        {
          ...
          city: 'Barcelona',
          description: '',
          transcript: '/my-cv/transcripts/Official_transcript_Nanoscience_UAB.pdf'
        },
        {
          id: 0,
          img: '/my-cv/media/uab-logo.png',
    ...
    experience: {
      ...
      jobList: [
        ...
        },
        {
          ...
          description: 'Developed and optimized photovoltaic systems by designing installations, conducting savings studies with custom software, and managing technical documentation to enhance solar production and self-consumption efficiency.',
          duties: [
      ...
      projectList: [
        {
          ...
          description: "Developing a blockchain-based voting system to ensure transparent and tamper-proof elections.",
        ...
        {
          id: 0,
          name: "Solar Energy Monitoring Dashboard",
          description: "Creating a real-time dashboard to monitor and analyze solar panel performance using IoT sensors.",
          technologies: ["Vue.js", "Node.js", "MongoDB", "MQTT"],
          githubLink: "https://github.com/yourusername/solar-dashboard",
          img: '',
        },
      ]
  },
